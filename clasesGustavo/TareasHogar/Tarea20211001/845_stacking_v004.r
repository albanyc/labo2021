...
kscript         <- "845_stacking_v004"

karch_dataset    <- "./datasets/dataset_stacking_v004.csv.gz"   #este dataset se genero en el script 811_dataset_epic.r

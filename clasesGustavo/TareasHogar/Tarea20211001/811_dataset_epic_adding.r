...
AgregarVariables  <- function( dataset )
{
  ...
  #razón saldo en cuenta ingreso
  dataset[ , saldo_ingreso:= mp_prestamos / mp_monto_payroll ]
  
  #razón prestamos-ingresos
  
  dataset[ , prestamos_ingreso:= mp_monto_cc_ca / mp_monto_payroll ]

...
#num leaves 50		1100
#FE el mismo que se hizo en 811-dataset-epic-adding V003
...
karch_dataset    <- "./datasets/dataset_epic_V003_hiper_cambios.csv.gz"   #este dataset se genero en el script 811_dataset_epic_adding.r
